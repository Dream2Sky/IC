...
namespace IC.CloudLink.WebApi.Migrations
{
    ...
    [Migration("20180223011945_UpdateFlowCardToUsers")]
    partial class UpdateFlowCardToUsers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IC.Core.Entity.CloudLink.DB.FlowPackageRecord", b =>
                {
                    ...
                    b.Property<string>("FlowPackageId");
            ...
            modelBuilder.Entity("IC.Core.Entity.CloudLink.DB.FlowPackage", b =>
                {
                    b.HasOne("IC.Core.Entity.CloudLink.DB.FlowCard")
                        .WithMany("FlowPackages")
                        .HasForeignKey("FlowCardId");
                });

            modelBuilder.Entity("IC.Core.Entity.CloudLink.DB.FlowPackageRecord", b =>
                {
                    b.HasOne("IC.Core.Entity.CloudLink.DB.FlowCard")
                        .WithMany("FlowPackageRecords")
                        .HasForeignKey("FlowCardId");

                    b.HasOne("IC.Core.Entity.CloudLink.DB.FlowPackage")
                        .WithMany("FlowPackageRecords")
                        .HasForeignKey("FlowPackageId");
